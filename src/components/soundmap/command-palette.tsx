...
const COMMANDS: CommandItem[] = [
  {
    id: "spl-analysis",
    label: "SPL Analysis · 3D",
    section: "Analizar",
    path: "/spl-analysis",
    keywords: ["cobertura", "frecuencia"],
  },
  {
  ...
  },
  {
    ...
    hint: "Wizard · Recinto → PA → DSP → Patch → Guardar",
    section: "Diseñar",
    path: "/design",
    keywords: ["recinto", "escaneo", "pa", "dsp", "stage", "canales", "wizard"],
  },
  {
    id: "design-room",
    label: "Wizard · Recinto",
    section: "Diseñar",
    path: "/design?step=room",
    keywords: ["dimensiones", "rt60", "materiales", "ar"],
  },
  {
    id: "design-pa",
    label: "Wizard · PA & Inventario",
    section: "Diseñar",
    path: "/design?step=pa",
    keywords: ["equipo", "tops", "subs", "amps"],
  },
  {
    id: "design-dsp",
    label: "Wizard · Cadena DSP",
    section: "Diseñar",
    path: "/design?step=dsp",
    keywords: ["eq", "xover", "delay"],
  },
  {
    id: "design-patch",
    label: "Wizard · Canales y patch",
    section: "Diseñar",
    path: "/design?step=patch",
  },
  {
    id: "design-save",
    label: "Wizard · Guardar & exportar",
    section: "Diseñar",
    path: "/design?step=save",
  },
  {
    id: "pa",
    label: "PA · Diseño avanzado",
    section: "Diseñar",
    path: "/pa",
    keywords: ["cobertura", "spl"],
  },
  {
    id: "stage-map",
    label: "Mapa de escenario",
    hint: "2D + 3D + Optimizer",
    section: "Diseñar",
    path: "/stage-map",
    keywords: ["stage", "3d", "optimizer"],
  },

  {
    id: "perform",
    label: "Perform Hub",
    hint: "SPL en vivo + escenas",
    section: "Ejecutar",
    path: "/perform",
    keywords: ["live", "hub"],
  },
  {
    id: "live",
    label: "Modo Live",
    hint: "SPL + grabación de sesión",
    section: "Ejecutar",
    path: "/live",
    keywords: ["spl", "leq", "rec"],
  },
  {
    id: "kiosk",
    label: "Kiosk FOH",
    hint: "SPL grande · referencias de ganancia",
    section: "Ejecutar",
    path: "/kiosk",
    keywords: ["panic", "faders", "big spl"],
  },

  {
    id: "compare",
    label: "Comparar A/B",
    hint: "Heatmap SPL diverging",
    section: "Analizar",
    path: "/compare",
    keywords: ["diff", "compare", "analiz"],
  },
  {
    id: "toolkit",
    label: "Toolkit",
    hint: "Cardioid · Line Array · Impedancia",
    section: "Analizar",
    path: "/toolkit",
    keywords: ["calc", "impedance"],
  },
  {
    id: "export",
    label: "Exportar reporte",
    hint: "PDF del sistema",
    section: "Analizar",
    path: "/export",
    keywords: ["pdf", "csv", "reporte"],
  },

  {
    id: "scenes",
    label: "Escenas guardadas",
    section: "Biblioteca",
    path: "/scenes",
    keywords: ["save", "load"],
  },
  {
    id: "templates",
    label: "Plantillas",
    hint: "5 rigs pre-hechos",
    section: "Biblioteca",
    path: "/templates",
    keywords: ["preset", "iglesia", "club"],
  },
  {
    id: "community",
    label: "Community Gear DB",
    section: "Biblioteca",
    path: "/community",
  },

  {
    id: "settings",
    label: "Ajustes",
    hint: "Audio · vibración · idioma · tour",
    section: "Ajustes",
    path: "/settings",
  },
];
...
export function CommandPalette({ open, onClose }: Props) {
  ...
  }, [open, items, activeIdx, onClose, run]);
    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="command-overlay fixed inset-0 z-[60] bg-black/60 backdrop-blur-md flex items-start justify-center pt-24 px-4"
          onClick={onClose}
        ...
        >
          <motion.div
            ...
            className="command-panel w-full max-w-xl rounded-lg bg-surface-1 overflow-hidden"
            style={{
              boxShadow:
          ...
          >
            ...
            <div className="flex items-center gap-3 px-5 py-4 border-b border-white/[0.05]">
              ...
              />
              <kbd className="px-1.5 py-0.5 rounded-md bg-white/5 text-[10px] font-mono text-muted-foreground">
                ESC
              </kbd>
            </div>
              ...
              {items.length === 0 ? (
                ...
                Object.entries(grouped).map(([section, cmds]) => (
                  <div key={section} className="px-1.5 py-1.5">
                    <p className="px-4 py-1.5 text-[10px] uppercase tracking-[0.22em] font-medium text-muted-foreground">
                      {section}
                    </p>
                    {cmds.map((c) => {
            ...
            <div className="px-5 py-2.5 border-t border-white/[0.05] flex items-center justify-between text-[10px] text-muted-foreground font-mono">
              <span className="flex items-center gap-3">
                <span className="flex items-center gap-1">
                  <kbd className="px-1 rounded bg-white/5">↑↓</kbd> navegar
                </span>
                <span className="flex items-center gap-1">
                  <kbd className="px-1 rounded bg-white/5">↵</kbd> abrir
                </span>
                <span className="flex items-center gap-1 hidden sm:inline-flex">
                  <kbd className="px-1 rounded bg-white/5">⌘K</kbd> alternar
                </span>
              </span>
              <span>

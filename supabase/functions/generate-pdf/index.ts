...
<style>
  ...
  h2{font-size:18px;font-weight:700;margin:28px 0 10px;color:#1aff6e;border-bottom:1px solid #e8e8e4;padding-bottom:6px}
  ...
  .val{font-weight:600;color:#1aff6e}
  ...
  .num{width:24px;height:24px;border-radius:50%;background:#1aff6e;color:#fff;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;flex-shrink:0}
</style>
</head>
<body>
